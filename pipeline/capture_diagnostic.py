...
Usage
─────
  python -m pipeline.capture_diagnostic
...
from pipeline.regime_analysis import (
    label_regimes,
    _load_macro,
    _load_spy_close,
    REGIME_ORDER,
...
from pipeline.signal_generation import (
    equity_index_regime,
    sector_regime,
    stock_regime,
...
from pipeline.portfolio import equal_weight_sizes, CAPITAL
