...
def step0_build_expanded_matrix() -> None:
    ...
    from pipeline.universe_expansion import NEW_TICKERS
...
def step1_data_integrity() -> dict:
    ...
    from pipeline.universe_expansion import NEW_TICKERS, SECTOR_MAP, SECTOR_STOCKS
...
def step2_signals() -> tuple:
    ...
    import importlib
    import pipeline.signal_generation as sg_mod
    ...
    from pipeline.universe_expansion import SECTOR_STOCKS, SECTOR_MAP
...
def step3_portfolio(alloc_expanded: float = 0.50) -> dict:
    ...
    from pipeline.portfolio import ALLOCATION_SPLIT
    from pipeline.regime_analysis import label_regimes
...
def step5_summary(ticker_stats: dict, composite: pd.DataFrame,
    ...
    from pipeline.universe_expansion import NEW_TICKERS, SECTOR_STOCKS
    from pipeline.portfolio import ALLOCATION_SPLIT
...
def main_from_step2() -> None:
    ...
    from pipeline.universe_expansion import NEW_TICKERS, SECTOR_MAP
    ticker_stats = {t: dict(beta=float("nan"), bear_beta=float("nan"),
